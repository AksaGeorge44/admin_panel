...
import '../../models1/productmodel/productmodel.dart';
import '../../provider1/provider.dart';
import '../auth_ui/login/login.dart';
import '../cartscreen/cartscreen.dart';
import '../offers/offers.dart';
import '../product_details/productdetails.dart';
import '../sidenav/sidenav.dart';
import 'package:admin_panel/models1/categorymodel/categorymodel.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: TextButton(onPressed: (){
            Routes.instance.push(widget: const MyDrawer(), context: context);
          }, child: const Icon(Icons.menu,color: Color.fromARGB(255, 19, 17, 17),)),
          actions: [
                ...
                child: Row(
                  ...
                  categoriesList.map(
                      ...
                      child: CupertinoButton(
                        ...
                        onPressed: (){
                          Routes.instance.push( context: context, widget:  const OfferScreen());
                        },
                        child: Card(
                          color: Colors.white,
                          elevation: 3.0,
